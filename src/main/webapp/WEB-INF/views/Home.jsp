...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#vender-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Vender</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="vender-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="addVender">
              <i class="bi bi-circle"></i><span>Add Vender</span>
            </a>
          </li>
          <li>
            <a href="listVender">
              <i class="bi bi-circle"></i><span>All Vender</span>
            </a>
          </li>
          <li>
          </ul>
