	            ...
	            <tbody>
	                <c:forEach items="${accountList}" var="i">
	                    <tr>
	                        ...
	                        <td>${i.title}</td>
	                        <td>${i.description}</td>
	                        <td data-type="date" data-format="YYYY/DD/MM">${i.transactionDate}</td>
	                        <td>
	                            <a href="viewAccount?accountId=${i.accountId}" class="btn btn-info btn-sm">View</a>
	                            <a href="editAccount?accountId=${i.accountId}" class="btn btn-warning btn-sm">Edit</a>
	                            <a href="deleteAccount?accountId=${i.accountId}" class="btn btn-danger btn-sm" 
