...
<head>
  ...
  <title>Users / Profile - TrackYourExp Bootstrap Template</title>
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <div class="social-links mt-2">
                <a href="#" class="twitter"><i class="ri-mail-fill"></i></a>
                <a href="#" class="facebook"><i class='bx bxs-phone'></i></a>
              </div>
            </div>
          </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <form action="editProfile" method="post">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="country" type="text" class="form-control" id="Country" value="${user.city}">
                      </div>
                    </div>
