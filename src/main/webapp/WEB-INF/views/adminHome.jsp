...
<body>
  ...
  <aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="listAccount">
          <i class="bi bi-grid"></i><span>Account</span>
        </a>
      </li><!-- End Account Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed"  href="listCategory">
          <i class="bi bi-grid"></i><span>Categories</span>
        </a>
      </li>
      <!-- End category Nav -->
      <li class="nav-item">
        <a class="nav-link collapsed"  href="listSubCategory">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="listVender">
